...
class AppDetailPagerAdapter(
    ...
    override fun getItem(position: Int) = when (position) {
        ...
        1 -> AppUsedPermissionDetailFragment()
        2 -> AppServiceDetailFragment()
        3 -> AppDefinedPermissionDetailFragment()
    ...
    override fun getPageTitle(position: Int): CharSequence = context.resources.getString(
        when (position) {
            0 -> R.string.general
            1 -> R.string.used_permissions
            2 -> R.string.services
            3 -> R.string.defined_permissions
