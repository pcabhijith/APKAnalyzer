...
public abstract class Hilt_AppDefinedPermissionDetailFragment<VM extends AppDetailPageFragmentViewModel, BINDING extends ViewDataBinding> extends AppDetailPageFragment<VM, BINDING> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AppDefinedPermissionDetailFragment_GeneratedInjector) this.generatedComponent()).injectAppDefinedPermissionDetailFragment(UnsafeCasts.<AppDefinedPermissionDetailFragment>unsafeCast(this));
    }
  }
