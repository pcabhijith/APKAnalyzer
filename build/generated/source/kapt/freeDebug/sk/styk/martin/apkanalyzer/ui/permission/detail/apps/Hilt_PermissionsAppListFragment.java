...
public abstract class Hilt_PermissionsAppListFragment<VM extends BaseAppListViewModel> extends BaseAppListFragment<VM> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PermissionsAppListFragment_GeneratedInjector) this.generatedComponent()).injectPermissionsAppListFragment(UnsafeCasts.<PermissionsAppListFragment>unsafeCast(this));
    }
  }
