...
public abstract class Hilt_MainAppListFragment<VM extends BaseAppListViewModel> extends BaseAppListFragment<VM> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MainAppListFragment_GeneratedInjector) this.generatedComponent()).injectMainAppListFragment(UnsafeCasts.<MainAppListFragment>unsafeCast(this));
    }
  }
