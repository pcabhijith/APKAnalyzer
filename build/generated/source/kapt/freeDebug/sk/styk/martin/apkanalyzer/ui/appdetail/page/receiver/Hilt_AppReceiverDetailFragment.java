...
public abstract class Hilt_AppReceiverDetailFragment<VM extends AppDetailPageFragmentViewModel, BINDING extends ViewDataBinding> extends AppDetailPageFragment<VM, BINDING> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AppReceiverDetailFragment_GeneratedInjector) this.generatedComponent()).injectAppReceiverDetailFragment(UnsafeCasts.<AppReceiverDetailFragment>unsafeCast(this));
    }
  }
