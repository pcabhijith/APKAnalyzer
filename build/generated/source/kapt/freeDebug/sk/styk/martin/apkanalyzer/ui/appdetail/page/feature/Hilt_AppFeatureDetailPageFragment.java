...
public abstract class Hilt_AppFeatureDetailPageFragment<VM extends AppDetailPageFragmentViewModel, BINDING extends ViewDataBinding> extends AppDetailPageFragment<VM, BINDING> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AppFeatureDetailPageFragment_GeneratedInjector) this.generatedComponent()).injectAppFeatureDetailPageFragment(UnsafeCasts.<AppFeatureDetailPageFragment>unsafeCast(this));
    }
  }
