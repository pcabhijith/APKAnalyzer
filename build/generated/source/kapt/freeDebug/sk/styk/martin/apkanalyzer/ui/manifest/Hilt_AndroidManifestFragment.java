...
public abstract class Hilt_AndroidManifestFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AndroidManifestFragment() {
    super();
  }

  Hilt_AndroidManifestFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AndroidManifestFragment_GeneratedInjector) this.generatedComponent()).injectAndroidManifestFragment(UnsafeCasts.<AndroidManifestFragment>unsafeCast(this));
    }
  }
