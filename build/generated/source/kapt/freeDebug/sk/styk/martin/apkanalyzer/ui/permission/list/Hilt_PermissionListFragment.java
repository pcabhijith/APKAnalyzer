...
public abstract class Hilt_PermissionListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PermissionListFragment() {
    super();
  }

  Hilt_PermissionListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PermissionListFragment_GeneratedInjector) this.generatedComponent()).injectPermissionListFragment(UnsafeCasts.<PermissionListFragment>unsafeCast(this));
    }
  }
