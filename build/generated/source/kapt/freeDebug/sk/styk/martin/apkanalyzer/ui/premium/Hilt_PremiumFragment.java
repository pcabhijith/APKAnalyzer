...
public abstract class Hilt_PremiumFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PremiumFragment() {
    super();
  }

  Hilt_PremiumFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PremiumFragment_GeneratedInjector) this.generatedComponent()).injectPremiumFragment(UnsafeCasts.<PremiumFragment>unsafeCast(this));
    }
  }
