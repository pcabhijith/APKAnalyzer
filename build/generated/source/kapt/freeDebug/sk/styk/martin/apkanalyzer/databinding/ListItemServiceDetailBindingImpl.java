...
public class ListItemServiceDetailBindingImpl extends ListItemServiceDetailBinding implements sk.styk.martin.apkanalyzer.generated.callback.OnLongClickListener.Listener {
    ...
    // variables
    @Nullable
    private final android.view.View.OnLongClickListener mCallback61;
    // values
    // listeners
    // Inverse Binding Event Handlers

    public ListItemServiceDetailBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }
    private ListItemServiceDetailBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback61 = new sk.styk.martin.apkanalyzer.generated.callback.OnLongClickListener(this, 1);
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x2L) != 0) {
            ...
            this.headerContainer.setOnLongClickListener(mCallback61);
        }
    }
