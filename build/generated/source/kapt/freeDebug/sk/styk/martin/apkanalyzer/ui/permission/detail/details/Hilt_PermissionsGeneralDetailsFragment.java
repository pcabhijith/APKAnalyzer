...
public abstract class Hilt_PermissionsGeneralDetailsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PermissionsGeneralDetailsFragment() {
    super();
  }

  Hilt_PermissionsGeneralDetailsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PermissionsGeneralDetailsFragment_GeneratedInjector) this.generatedComponent()).injectPermissionsGeneralDetailsFragment(UnsafeCasts.<PermissionsGeneralDetailsFragment>unsafeCast(this));
    }
  }
