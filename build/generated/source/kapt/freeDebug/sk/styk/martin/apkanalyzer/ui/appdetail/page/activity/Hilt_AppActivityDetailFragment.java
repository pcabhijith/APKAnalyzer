...
public abstract class Hilt_AppActivityDetailFragment<VM extends AppDetailPageFragmentViewModel, BINDING extends ViewDataBinding> extends AppDetailPageFragment<VM, BINDING> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AppActivityDetailFragment_GeneratedInjector) this.generatedComponent()).injectAppActivityDetailFragment(UnsafeCasts.<AppActivityDetailFragment>unsafeCast(this));
    }
  }
