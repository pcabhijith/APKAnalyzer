...
public abstract class Hilt_AppCertificateDetailFragment<VM extends AppDetailPageFragmentViewModel, BINDING extends ViewDataBinding> extends AppDetailPageFragment<VM, BINDING> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AppCertificateDetailFragment_GeneratedInjector) this.generatedComponent()).injectAppCertificateDetailFragment(UnsafeCasts.<AppCertificateDetailFragment>unsafeCast(this));
    }
  }
