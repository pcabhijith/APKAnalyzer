...
public abstract class Hilt_PermissionDetailFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PermissionDetailFragment() {
    super();
  }

  Hilt_PermissionDetailFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PermissionDetailFragment_GeneratedInjector) this.generatedComponent()).injectPermissionDetailFragment(UnsafeCasts.<PermissionDetailFragment>unsafeCast(this));
    }
  }
