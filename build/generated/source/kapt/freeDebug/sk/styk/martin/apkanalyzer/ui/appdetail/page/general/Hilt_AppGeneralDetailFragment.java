...
public abstract class Hilt_AppGeneralDetailFragment<VM extends AppDetailPageFragmentViewModel, BINDING extends ViewDataBinding> extends AppDetailPageFragment<VM, BINDING> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AppGeneralDetailFragment_GeneratedInjector) this.generatedComponent()).injectAppGeneralDetailFragment(UnsafeCasts.<AppGeneralDetailFragment>unsafeCast(this));
    }
  }
