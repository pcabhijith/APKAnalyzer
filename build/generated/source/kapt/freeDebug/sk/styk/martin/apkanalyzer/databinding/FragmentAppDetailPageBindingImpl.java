...
public class FragmentAppDetailPageBindingImpl extends FragmentAppDetailPageBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.item_detail_loading, 2);
        sViewsWithIds.put(R.id.item_detail_error, 3);
    }
    // views
    @NonNull
    ...
    public FragmentAppDetailPageBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }
    private FragmentAppDetailPageBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((sk.styk.martin.apkanalyzer.ui.appdetail.page.AppDetailPageFragmentViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable sk.styk.martin.apkanalyzer.ui.appdetail.page.AppDetailPageFragmentViewModel ViewModel) {
    ...
    protected void executeBindings() {
        ...
        sk.styk.martin.apkanalyzer.ui.appdetail.page.DetailInfoDescriptionAdapter<?> viewModelAdapter = null;
        androidx.lifecycle.LiveData<java.lang.Integer> viewModelViewState = null;
        java.lang.Integer viewModelViewStateGetValue = null;
        sk.styk.martin.apkanalyzer.ui.appdetail.page.AppDetailPageFragmentViewModel viewModel = mViewModel;
        ...
        if ((dirtyFlags & 0x6L) != 0) {
            ...
            this.mboundView1.setAdapter(viewModelAdapter);
        }
        if ((dirtyFlags & 0x4L) != 0) {
            // api target 1

            sk.styk.martin.apkanalyzer.util.bindingadapters.RecyclerViewBindingAdaptersKt.itemDecoration(this.mboundView1, true);
        }
    }
