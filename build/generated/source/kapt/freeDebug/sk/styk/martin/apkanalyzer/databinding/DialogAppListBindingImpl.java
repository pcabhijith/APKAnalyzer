...
public class DialogAppListBindingImpl extends DialogAppListBinding  {
    ...
    public DialogAppListBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }
    private DialogAppListBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        this.recyclerViewApplications.setTag(null);
        setRootTag(root);
        // listeners
        invalidateAll();
    }
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((sk.styk.martin.apkanalyzer.ui.applist.packagename.AppListFromPackageNamesDialogViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable sk.styk.martin.apkanalyzer.ui.applist.packagename.AppListFromPackageNamesDialogViewModel ViewModel) {
    ...
    protected void executeBindings() {
        ...
        sk.styk.martin.apkanalyzer.ui.applist.packagename.AppListFromPackageNamesDialogViewModel viewModel = mViewModel;
        ...
        if ((dirtyFlags & 0x6L) != 0) {
            ...
            this.recyclerViewApplications.setAdapter(viewModelAdapter);
        }
        if ((dirtyFlags & 0x4L) != 0) {
            // api target 1

            sk.styk.martin.apkanalyzer.util.bindingadapters.RecyclerViewBindingAdaptersKt.itemDecoration(this.recyclerViewApplications, true);
        }
    }
