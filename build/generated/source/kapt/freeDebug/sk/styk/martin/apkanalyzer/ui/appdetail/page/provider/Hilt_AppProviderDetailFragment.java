...
public abstract class Hilt_AppProviderDetailFragment<VM extends AppDetailPageFragmentViewModel, BINDING extends ViewDataBinding> extends AppDetailPageFragment<VM, BINDING> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AppProviderDetailFragment_GeneratedInjector) this.generatedComponent()).injectAppProviderDetailFragment(UnsafeCasts.<AppProviderDetailFragment>unsafeCast(this));
    }
  }
