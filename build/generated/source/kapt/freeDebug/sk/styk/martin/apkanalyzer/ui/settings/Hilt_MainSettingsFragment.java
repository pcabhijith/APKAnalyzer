...
public abstract class Hilt_MainSettingsFragment extends PreferenceFragmentCompat implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MainSettingsFragment_GeneratedInjector) this.generatedComponent()).injectMainSettingsFragment(UnsafeCasts.<MainSettingsFragment>unsafeCast(this));
    }
  }
