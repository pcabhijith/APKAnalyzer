...
public abstract class Hilt_AppUsedPermissionDetailFragment<VM extends AppDetailPageFragmentViewModel, BINDING extends ViewDataBinding> extends AppDetailPageFragment<VM, BINDING> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AppUsedPermissionDetailFragment_GeneratedInjector) this.generatedComponent()).injectAppUsedPermissionDetailFragment(UnsafeCasts.<AppUsedPermissionDetailFragment>unsafeCast(this));
    }
  }
