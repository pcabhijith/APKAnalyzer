...
public abstract class Hilt_AppListFromPackageNamesDialog extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AppListFromPackageNamesDialog() {
    super();
  }

  Hilt_AppListFromPackageNamesDialog(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AppListFromPackageNamesDialog_GeneratedInjector) this.generatedComponent()).injectAppListFromPackageNamesDialog(UnsafeCasts.<AppListFromPackageNamesDialog>unsafeCast(this));
    }
  }
